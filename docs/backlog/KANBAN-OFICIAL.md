...
| 31 | `HT-018` | Remover a lógica de negócio e os mocks do frontend | Técnica | **Em revisão** | HN-010, HN-011 | Fecha a fronteira aberta em `HT-017` |
...
### Em revisão
- `HN-011` — Simulação de compra e exportação PDF/CSV
