...
| 31 | `HT-018` | Remover a lógica de negócio e os mocks do frontend | Técnica | **Done** | HN-010, HN-011 | Fecha a fronteira aberta em `HT-017` |
