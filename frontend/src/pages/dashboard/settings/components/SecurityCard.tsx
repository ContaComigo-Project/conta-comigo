    ...
    <div className="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-xs space-y-6">
      <div className="flex items-center justify-between pb-3 border-b border-slate-100">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h2 className="text-base font-bold text-[#001b42]">Segurança e Sessão</h2>
      ...
      <div className="space-y-4">
        ...
        <div className="pt-2 flex justify-end">
          <button
            ...
            disabled={encerrando}
            className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl border border-slate-200 text-xs font-semibold text-slate-700 bg-white hover:bg-slate-50 hover:text-slate-900 transition-all shadow-2xs disabled:opacity-50"
          >
            {encerrando ? (
