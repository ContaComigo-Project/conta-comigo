    ...
    <div className="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-xs space-y-6">
      <div className="flex items-center justify-between pb-3 border-b border-slate-100">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h2 className="text-base font-bold text-[#001b42]">Perfil do Titular</h2>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-5">
        {/* Avatar */}
        <div className="w-16 h-16 rounded-2xl bg-[#001b42] text-white flex items-center justify-center text-xl font-bold shadow-sm shrink-0">
          {perfil.iniciais}
        </div>
        ...
        <div className="space-y-1">
          ...
          <div className="flex items-center gap-2 text-xs text-slate-400 pt-1">
            <Shield className="w-3.5 h-3.5 text-[#36b37e]" />
