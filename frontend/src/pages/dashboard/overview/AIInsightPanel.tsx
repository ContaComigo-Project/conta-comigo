...
import { mockAIInsights, type AIInsight } from '../../../data/dashboard.mock';
  ...
  return (
    <div className="flex items-center gap-2">
      <div className="flex-1 h-1.5 bg-slate-200 rounded-full overflow-hidden">
        <div
          className="h-full rounded-full bg-gradient-to-r from-[#36b37e] to-[#0a6d42] transition-all duration-700"
          style={{ width: `${value}%` }}
        />
      </div>
    ...
    <div className={`rounded-2xl border-2 p-5 transition-all duration-300 animate-fade-in ${config.borderClass} bg-white shadow-[0_4px_24px_rgba(54,179,126,0.08)]`}>
      <div className="flex items-start justify-between mb-3 gap-3">
        <div className="flex items-center gap-2.5">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#36b37e] to-[#0a6d42] flex items-center justify-center text-white shadow-sm shadow-[#36b37e]/30 shrink-0">
    ...
    <section aria-label="Insights de IA">
      <div className="flex items-center justify-between mb-3">
        <h2 className="text-sm font-bold text-slate-700 flex items-center gap-2">
          <span className="w-6 h-6 rounded-lg bg-gradient-to-br from-[#36b37e] to-[#0a6d42] flex items-center justify-center text-white">
