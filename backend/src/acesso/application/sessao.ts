...
// cada renovacao. O que importa e o mesmo nos dois casos: o banco guarda o
// hash, nunca o valor.
export const gerarRefresh = () => randomBytes(32).toString('base64url');
export const hashDoRefresh = (refresh: string) => createHash('sha256').update(refresh).digest('hex');
